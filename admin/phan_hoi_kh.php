                    ...
                    <div >
                      <div class="container-list">
                        <div class="display-flex">
                            <h2 class="container-heading">Danh sách phản hồi của khách hàng</h2>
                                    ...
                                    <tbody>
                                       ...
                                       echo '
                                        <tr>
                                            ...
                                            <td style="text-align: center;">'.$row['ho_va_ten'].'</td>
                                            <td style="text-align: center;">'.$row['email'].'</td>
                                            <td style="text-align: center;">
                                            <a href="xem_phan_hoi.php?id='.$row['id_phan_hoi'].'">
