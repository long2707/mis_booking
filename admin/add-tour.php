                    ...
                    <div >
                      <div class="container-list">
                        <div class="display-flex">
                            <h2 class="container-heading">Thêm tour mới</h2>
                         
                        </div>
                      </div>
                        <div class="card mb-4 px-4">
                            <div class="card-body">
                            <form method="POST" action="add-tour-action.php" enctype="multipart/form-data">
                                    <div class="form-group">
                                        <div class="col-md-6 padd-left-0">
                                            <label for="txtTenTour">Tên tour</label>
                                            <input class="form-control" id="txtTenTour" name="txtTenTour" placeholder="Nhập tên tour" />
                                        </div>
                                        <div class="col-md-6 padd-right-0">
                                            <label for="txtLoaiHinh">Loại hình</label>
                                            <input class="form-control" id="txtLoaiHinh" name="txtLoaiHinh" placeholder="Nhập loại dịch vụ" />
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="col-md-6 padd-left-0">
                                            <label for="txtThoiGian">Thời gian</label>
                                            <input class="form-control" id="txtThoiGian" name="txtThoiGian" placeholder="Nhập khoảng thời gian của tour" />
                                        </div>
                                        <div class="color-md-6 padd-right-0">
                                            <label for="txtGia">Giá tour</label>
                                            <input class="form-control" id="txtGia" name="txtGia" placeholder="Nhập giá tour" />
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="col-md-6 padd-left-0">
                                            <label for="txtDV1">Dịch vụ 1</label>
                                            <input class="form-control" id="txtDV1" name="txtDV1" placeholder="Nhập Dịch vụ 1" />
                                        </div>
                                        <div class="col-md-6 padd-right-0">
                                            <label for="txtDV2">Dịch vụ 2</label>
                                            <input class="form-control" id="txtDV2" name="txtDV2" placeholder="Nhập Dịch vụ 2" />
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="col-md-6 padd-left-0">
                                            <label for="txtDV3">Dịch vụ 3</label>
                                            <input class="form-control" id="txtDV3" name="txtDV3" placeholder="Nhập Dịch vụ 3" />
                                        </div>
                                        <div class="col-md-6 padd-right-0">
                                            <label for="txtDV4">Dịch vụ 4</label>
                                            <input class="form-control" id="txtDV4" name="txtDV4" placeholder="Nhập Dịch vụ 4" />
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="col-md-6 padd-left-0">
                                            <label for="txtDV5">Dịch vụ 5</label>
                                            <input class="form-control" id="txtDV5" name="txtDV5" placeholder="Nhập Dịch vụ 5" />
                                        </div>
                                        <div class="col-md-6 padd-right-0">
                                            <label for="txtLink">Link</label>
                                            <input class="form-control" id="txtLink" name="txtLink" placeholder="Nhập Link" />
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <div class="col-md-6 padd-left-0">
                                            ...
                                            <input type="file" class="form-control  control-flie" id="txtAnhMinhHoa1" name="txtAnhMinhHoa1" placeholder="Ảnh minh họa 1" />

                                        </div>
                                        <div class="col-md-6 padd-left-0">
                                            <label for="txtAnhMinhHoa2">Ảnh minh họa 2</label>
                                            <input type="file" class="form-control  control-flie" id="txtAnhMinhHoa2" name="txtAnhMinhHoa2" placeholder="Ảnh minh họa 2" />
                                    ...
                                    <div class="form-group">
                                        <div class="col-md-6 padd-left-0">
                                            ...
                                            <input class="form-control" id="txtGioiThieu" name="txtGioiThieu" placeholder="Nhập" />
                                        </div>
