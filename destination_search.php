            ...
            <div class="col-md-9"> 
              <div class="row">
                <?php
                  ...
                  $the_loai=$_GET["select-trip"];
                  $dia_diem=$_GET["dia_diem"];
                  $thoi_gian=$_GET["duraion"];
                  
                  $ket_noi = mysqli_connect("localhost","root","","mis_booking");

                  $sql=" SELECT * FROM `tbl_tour` WHERE `loai_hinh` LIKE '".$the_loai."' AND (`diem_den` LIKE '%".$dia_diem."' OR `diem_den` LIKE '".$dia_diem."%' ) AND `khoang_thoi_gian` LIKE '".$thoi_gian."' ";
